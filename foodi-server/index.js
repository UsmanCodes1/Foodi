...
mongoose
  .connect(
    `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@foodi.w7212zs.mongodb.net/Foodi_app?retryWrites=true&w=majority`
  )
  .then(console.log("Mongodb connected finally successfully!"))
